...
answer = window.prompt('Do you head left or right?')

if (answer = 'left')
{
    answer = window.prompt('You come across a stray cat. It scampers off down a small hole just large enough for you to crawl through. Do you follow it or continue on your path?')
}

    if (answer = 'follow')
    {
        answer = window.prompt('You follow the cat to a colony of cats, nestled in a fort of warm blankets and subsisting off of inexplicably warm soup. They are content with you staying, but you wonder if you should alert the world to this magical safe haven. Should you stay, or go spread the word and later return?')
    }
        if (answer = 'stay')
        {
    ...
    if (answer = 'continue')
    {
        answer = window.prompt('You come across a chamber that reaches upward to a shining light above. There is a long, winding staircase, and a much quicker, but rickety-looking ladder that leads up toward the light. Which do you take?')
    }
        if (answer = 'ladder')
        {
...
if (answer = 'right')
{
    window.prompt('You come across a snoring dragon. On the other side of him, you see a shiny chest of treasure. Another path would lead you away from the dragon altogether. Which do you take?')
}
    if (answer = 'past the dragon')
    {
        window.prompt('The dragon wakes up and sits upright. You only have a moment to respond, to stay or run:')
    }
        if (answer = 'stay')
        {
    ...
    if (answer = 'away from the dragon')
    {
